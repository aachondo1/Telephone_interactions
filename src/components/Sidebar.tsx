...
export type Section = 'inicio' | 'llamadas' | 'colas' | 'queue-health' | 'ejecutivos' | 'planificacion' | 'intervencion' | 'audit';
...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: 'queue-health',   label: 'Salud de Cola',   icon: Layers,          group: 'analysis' },
