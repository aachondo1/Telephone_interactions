...
import type { ExecutiveHourlyTalkTime } from '../lib/kpi';
import { formatDuration } from '../lib/kpi';

type Props = {
  data: ExecutiveHourlyTalkTime[];
  executives: string[];
...
export function ExecutiveTalkTimeByHour({ data, executives, allExecutives }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
      <div className="mb-4 flex items-start justify-between">
        <div>
          <h3 className="text-sm font-semibold text-slate-700">Tiempo en teléfono por hora</h3>
